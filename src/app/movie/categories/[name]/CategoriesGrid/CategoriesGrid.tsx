...
import type { Collection, MovieMedia, ProductionMedia } from "@services/types";
...
export const CategoryGrid = ({ collection }: Props) => {
  const [currentPage, setCurrentPage] = useState(1);
  const [productions, setProductions] = useState<MovieMedia[]>([]);
